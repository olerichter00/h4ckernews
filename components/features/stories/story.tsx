...
const Story: React.FC<StoryProps> = ({ story }) => {
  ...
  return (
    <div className="m-2 mb-3 sm:mb-6 sm:my-8">
      <div className="sm:dark:bg-transparent flex flex-col pb-4 max-w-full dark:bg-gray-800 bg-white rounded-xl overflow-hidden sm:flex-row sm:pb-0 sm:w-full sm:bg-transparent sm:rounded-none">
        <StoryImage
          imageUrls={imageUrls || []}
